  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="rounded-2xl border border-border bg-card p-6 backdrop-blur-xl space-y-6">
        <div>
          <h3 className="text-base font-bold text-foreground mb-1">Water Feeder Buffer Allocation</h3>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 text-xs font-mono">
          <div className="p-3.5 rounded-xl bg-inset border border-border/60">
            <span className="text-faint block text-2xs">PLANNED PUMPING</span>
            <span className="text-base font-bold text-foreground">12.4M L / day</span>
          </div>
          <div className="p-3.5 rounded-xl bg-inset border border-border/60">
            <span className="text-faint block text-2xs">HIGH DEMAND WARD 24</span>
            <span className="text-base font-bold text-amber-ink">+350,000 L buffer</span>
          </div>
          <div className="p-3.5 rounded-xl bg-inset border border-border/60">
            <span className="text-faint block text-2xs">SCHEDULE SHIFT</span>
            <span className="text-base font-bold text-positive">7:00 – 8:15 AM</span>
          </div>
        </div>

        <div className="pt-4 border-t border-border/60">
          <h3 className="text-base font-bold text-foreground mb-1">LPG Distributor Supply Quota</h3>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 text-xs font-mono">
            <div className="p-3.5 rounded-xl bg-inset border border-border/60">
              <span className="text-faint block text-2xs">TOTAL REQUIREMENT</span>
              <span className="text-base font-bold text-foreground">4,437 Cylinders</span>
            </div>
            <div className="p-3.5 rounded-xl bg-inset border border-border/60">
              <span className="text-faint block text-2xs">SAFETY BUFFER (+5%)</span>
              <span className="text-base font-bold text-teal-ink">220 Cylinders</span>
            </div>
            <div className="p-3.5 rounded-xl bg-inset border border-border/60">
              <span className="text-faint block text-2xs">DISPATCH STATUS</span>
              <span className="text-base font-bold text-positive">Approved</span>
            </div>
          </div>
        </div>
