      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
        ...
        <div className="p-6 rounded-2xl border border-border bg-card backdrop-blur-xl flex flex-col justify-between">
          <div>
            ...
            <div className="text-2xl font-bold font-display text-foreground mb-1">₹3,120</div>
            <p className="text-xs text-muted-foreground mb-4">390 kWh recorded · Due date: 05 October 2026</p>
          </div>

          <div className="pt-4 border-t border-border/60">
            {electricityPaid ? (
              <div className="flex items-center gap-2 p-2.5 rounded-xl bg-positive/10 border border-positive/20 text-xs text-positive font-medium">
        ...
        <div className="p-6 rounded-2xl border border-border bg-card backdrop-blur-xl flex flex-col justify-between">
          <div>
            ...
            <div className="text-2xl font-bold font-display text-foreground mb-1">₹450</div>
            <p className="text-xs text-muted-foreground mb-4">Fixed quarterly residential cess · Due: 15 Oct 2026</p>
          </div>
          ...
          <div className="pt-4 border-t border-border/60">
            {waterPaid ? (
              ...
              <Button
                ...
                className="w-full bg-positive text-positive-foreground hover:bg-positive/90 font-semibold text-xs h-9 gap-2"
              >
                <CreditCard className="h-3.5 w-3.5" />
